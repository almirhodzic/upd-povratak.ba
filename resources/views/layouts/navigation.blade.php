    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-z.application-logo class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-z.dropdown align="right" width="48">
                    <x-slot name="trigger">
                    ...
                    <x-slot name="content">
                        <x-z.dropdown-link :href="route('profile.edit')">
                            {{ __('Profile') }}
                        </x-z.dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-z.dropdown-link :href="route('logout')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-z.responsive-nav-link :href="route('profile.edit')">
                    {{ __('Profile') }}
                </x-z.responsive-nav-link>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-z.responsive-nav-link :href="route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-z.responsive-nav-link>
