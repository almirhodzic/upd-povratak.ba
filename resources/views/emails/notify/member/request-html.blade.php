<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" style="font-size:16px !important;">
   ...
   <tr><td valign="top">Ulica i broj</td><td valign="top">{{ $memberStreet }}</td></tr>
   <tr><td valign="top">Postanski broj</td><td valign="top">{{ $memberPostcode }}</td></tr>
   <tr><td valign="top">Opcina</td><td valign="top">{{ $memberCity }}</td></tr>
